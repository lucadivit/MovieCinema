    ...
    <div id="datiregistrazione">
        ...
        <fieldset>
            <div id="userpsw">
                ...
                <label>Username:</label> <input type="text" id="username" placeholder="Username" value="{$datiutente.username}" size="20" maxlength="40" readonly><div id="risultato1"></div><br>
                <label>Password:</label> <input type="password" id="password" value="{$datiutente.password}" placeholder="Password" size="20" maxlength="40" onchange="validazione('password');" onclick="checkpass();" readonly><a href=# onclick='return false;'><img src="./immagini/index.jpg" title="modifica" id="index" class='opzut' onclick="modifica('password');"></a><div id="risultato2">
                </div><br>
        ...
        <fieldset>
            ...
            <label>Nome:</label><input type="text" placeholder="Nome" size="20" maxlength="40" value="{$datiutente.nome}" id="nome" onchange="validazione('nome');" readonly><a href=# onclick='return false;'><img src="./immagini/index.jpg" title="modifica" id="index" class='opzut' onclick="modifica('nome');"></a><div id="risultato3"></div><br>
            <label>Cognome:</label><input type="text" id="cognome" size="20" maxlength="40" value="{$datiutente.cognome}" placeholder="Cognome" onchange="validazione('cognome');" readonly><a href=# onclick='return false;'><img src="./immagini/index.jpg" title="modifica" id="index" class='opzut' onclick="modifica('cognome');"></a><div id="risultato4"></div><br>
            ...
            <label>E-Mail:</label><input type="text" id="email" size="40" value="{$datiutente.email}" maxlength="40" placeholder="Inserisci indirizzo e-mail" onchange="validazione('email');" readonly><a href=# onclick='return false;'><img src="./immagini/index.jpg" title="modifica" id="index" class='opzut' onclick="modifica('email');"></a><div id="risultato8"></div><br>
